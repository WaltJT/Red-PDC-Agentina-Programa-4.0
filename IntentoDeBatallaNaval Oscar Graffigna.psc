...
SubProceso JugandoSilencioso(matriz Por Referencia,vacio Por Referencia,v Por Referencia, resultado Por Referencia)
	...
	Hacer
		...
		Si	v[coordBotI,coordBotJ] <> "|   " Entonces
			Escribir "Le dieron a un barco tuyo"
			v[coordBotI,coordBotJ] = "|-X-"
		SiNo
			Escribir "No le dieron a tus barcos"
			v[coordBotI,coordBotJ] = "|-O-"
		FinSi
		Escribir "Jugador"
		dibujartablero(v)
		Escribir ""
		...
		para i<-1 Hasta 10 Hacer
			para j<-1 Hasta 10 Hacer
				si matriz[i,j]="| 2 " o matriz[i,j]="| 3 " o matriz[i,j]="| 4 " o acumG>0 Entonces
					...
					resultado=0
				FinSi
				si v[i,j]="| 2 " o v[i,j]="| 3 " o v[i,j]="| 4 " o acump>0 Entonces
					resultado=0
					acump=acump+1					
				FinSi
			FinPara
...
SubProceso Jugando(matriz Por Referencia,v Por Referencia,resultado Por Referencia)
	Definir coord, coordletra, coordnum Como Caracter
	Definir i, j, coordL, coordN, coordBotI, coordBotJ, acump, acumG Como Entero
	Definir juega Como Caracter
	Hacer
