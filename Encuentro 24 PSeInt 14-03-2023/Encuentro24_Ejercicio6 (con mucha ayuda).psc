<<<<<<< HEAD
Algoritmo Encuentro24_Ejercicio6
...
//	que no debe superar orden igual a 10.
	...
	Definir matriz,i,j,N,sumadiagonal,sumalinea,contador,diagonal,diagonalinversa como Entero;
	Definir columnas,filas,matrizMagica,matrizMagicaSinDiagonal,diagonales Como Logico;
...
Hacer 
	...
	Para i=0 Hasta N-1 con paso 1 Hacer
		...
		Para j=0 Hasta N-1 Con Paso 1 Hacer
			...
			Escribir Sin Saltar matriz(N,N);
	...
	Si N % 2 <> 0 Entonces
		...
		matrizMagica = columnas Y filas Y diagonales;
...
Mientras Que  matrizMagicaSinDiagonal <> Verdadero Y matrizMagica <> Verdadero
	
FinAlgoritmo

Funcion retorno = sumadorColumna(matriz,N)
	Definir i,j,SumaColumna,contadorFalso,Aux Como Entero;
	Definir ColumnasFalsas,retorno Como Logico;
	contadorFalso = 0;
	aux = 0;
	Para j = 0 Hasta N-1 Hacer
		SumaColumna = 0;
	...
	FinSi
	Escribir ColumnasFalsas;
	retorno = ColumnasFalsas;
...
Funcion retorno = sumadorFila(matriz,N)
	Definir i,j,sumaFila,contadorFalso,Aux Como Entero;
	Definir filasFalsas,retorno Como Logico;
	contadorFalso = 0;
	Para i = 0 Hasta N-1 Hacer
		sumaFila = 0;
		Para j = 0 Hasta N-1 Hacer
