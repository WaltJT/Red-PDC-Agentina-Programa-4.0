...
//a través de tres enteros dia, mes y año, y retorne la fecha anterior. Puede asumir que
//dia, mes y año representan una fecha válida. Realice pruebas de escritorio para los valores
//dia=5, mes=10, año=2012 y para dia=1, mes=3, anio=2004.
	
	Definir dia,mes,anno,fecha como Entero;
	
	Escribir "Por favor ingrese un valor numerico para día: ";
	Leer dia;
	
	Escribir "Por favor ingrese un valor numerico para mes: ";
	Leer mes;
	
	Escribir "Por favor ingrese un valor numerico para año: ";
	Leer anno;
